...
features_train = vectorizer.fit_transform(str(feature_train) for feature_train in features_train).toarray()
features_test  = vectorizer.transform(str(feature_test) for feature_test in features_test).toarray()
